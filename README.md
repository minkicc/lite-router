...
Desktop application data is stored in the system application configuration directory under the identifier `cc.minki.literouter`. On Windows, it is usually located at:
